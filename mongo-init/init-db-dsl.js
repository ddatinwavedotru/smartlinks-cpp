// MongoDB initialization script with DSL rules
// Создаёт отдельную базу данных LinksDSL для DSL тестов
...
print("MongoDB DSL initialization complete. Test data with DSL rules inserted.");
